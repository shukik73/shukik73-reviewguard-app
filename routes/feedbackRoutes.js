...
export default function createFeedbackRoutes(pool, requireAuth) {
  ...
  router.put('/api/feedback/:id/status', requireAuth, basicAuth, feedbackController.updateFeedbackStatus(pool));
  router.put('/api/feedback/:id/assign', requireAuth, basicAuth, feedbackController.assignFeedback(pool));
