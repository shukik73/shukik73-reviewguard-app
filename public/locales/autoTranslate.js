const autoTranslate = {
  dictionary: {
    ...
    es: {
      ...
      "Configure your business profile and SMS templates": "Configura tu perfil de negocio y plantillas SMS",
      "SMS Template": "Plantilla SMS",
      "Admin Password Protection": "Protección con Contraseña de Admin",
      "Require admin password for sensitive data access": "Requiere contraseña de admin para acceso a datos sensibles",
      "Not Configured": "No Configurado",
      "Connect your Telegram bot for review approval notifications": "Conecta tu bot de Telegram para notificaciones de aprobación de reseñas",
      "Bot Token": "Token del Bot",
      "Chat ID": "ID del Chat",
      "Save Telegram Settings": "Guardar Configuración de Telegram",
      ...
      "This changes templates and terminology to match your industry": "Esto cambia plantillas y terminología según tu industria",
      "Send SMS": "Enviar SMS",
      "History": "Historial",
      "Customers": "Clientes",
      "Reviews": "Reseñas",
      ...
      "customers selected": "clientes seleccionados",
      ...
      "Review Clicked": "Reseña Clickeada",
      "Review Posted": "Reseña Publicada",
      ...
      "Analyzing receipt...": "Analizando recibo...",
      ...
      "Nail Salon / Spa": "Salón de Uñas / Spa",
      ...
      "🔧 Plumbing": "🔧 Plomería",
      "💅 Thanks for visiting us today!": "💅 ¡Gracias por visitarnos hoy!",
      "💈 Thanks for the visit! Looking sharp!": "💈 ¡Gracias por la visita! ¡Te ves genial!",
      "Appointment Set": "Cita Programada",
      "In Service": "En Servicio",
      "Waiting": "Esperando",
      "In Chair": "En la Silla",
      "Service Consent Verified": "Consentimiento de Servicio Verificado",
  ...
  translateElement(root, dict) {
    ...
    root.querySelectorAll('[title]').forEach(el => {
      ...
      if (dict[title]) el.title = dict[title];
    });
  },
  ...
  updateButtonStates() {
    document.querySelectorAll('[data-lang-switch]').forEach(btn => {
      ...
      if (btnLang === this.currentLang) {
        btn.className = 'px-2 py-1 rounded text-xs font-medium bg-accent text-white';
      } else {
        btn.className = 'px-2 py-1 rounded text-xs font-medium bg-slate-700 text-slate-300';
      }
    });
  }
};
