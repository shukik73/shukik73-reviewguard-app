const smartTemplates = {
  templates: {
    ...
    beauty: {
      completion: {
        en: "Hi {{name}}, thanks for visiting {{business}} today! We hope you love your look. Rate your experience: {{link}}",
        es: "Hola {{name}}, ¡gracias por visitarnos hoy en {{business}}! Esperamos que te encante tu look. Califica tu experiencia: {{link}}"
      },
      review: {
        en: "Hi {{name}}! Thank you for choosing {{business}}. We'd love your feedback: {{link}}",
        es: "¡Hola {{name}}! Gracias por elegir {{business}}. Nos encantaría tu opinión: {{link}}"
      },
      follow_up: {
        en: "Hi {{name}}! How are you loving your new look? We'd love to see you again soon at {{business}}!",
        es: "¡Hola {{name}}! ¿Te encanta tu nuevo look? ¡Nos encantaría verte pronto en {{business}}!"
      }
    },
    barber: {
      completion: {
        en: "Hi {{name}}, thanks for the visit! Looking sharp! Rate us: {{link}}",
        es: "Hola {{name}}, ¡gracias por la visita! ¡Te ves genial! Califícanos: {{link}}"
      },
      review: {
        en: "Hi {{name}}! Thanks for choosing {{business}}. How did we do? {{link}}",
        es: "¡Hola {{name}}! Gracias por elegir {{business}}. ¿Cómo lo hicimos? {{link}}"
      },
      follow_up: {
        en: "Hi {{name}}! Time for a fresh cut? Book your next appointment at {{business}}!",
        es: "¡Hola {{name}}! ¿Es hora de un nuevo corte? ¡Agenda tu próxima cita en {{business}}!"
      }
    }
  },
